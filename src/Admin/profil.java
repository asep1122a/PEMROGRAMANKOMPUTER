...
public class profil extends javax.swing.JFrame {
    private Profiluser pr;
    
    public profil(Profiluser pr) {
        initComponents();
 ...
 private void loadUser () {
        if (pr != null) {
            System.out.println("nama_lengkap: " + pr.getNama());
            System.out.println("alamat: " + pr.getAlamat());
            System.out.println("nomor_telepon: " + pr.getTelepon());
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        switch (pr.getRole()) {
            case "admin" -> {
                ...
                adminpage ha = new adminpage(this.pr); // Kirim userprofile ke halaman admin
                ha.setVisible(true);
