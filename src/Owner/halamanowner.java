...
public class halamanowner extends javax.swing.JFrame {
    ...
    public halamanowner(Profiluser o) {
        initComponents();

        this.pr = o;
        labelnama.setText(pr.getNama() + "(" + pr.getRole()+ ")");
...
//        hp.setVisible(true); // Tampilkan halaman profil1
//        this.dispose(); // Tutup halaman admin jika perlu
//  
//        // Membuka halaman profil1 dengan mengirimkan objek userprofile
//        
