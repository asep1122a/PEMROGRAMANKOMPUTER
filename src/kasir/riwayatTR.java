...
public class riwayatTR extends javax.swing.JFrame {
    ...
    public riwayatTR(Profiluser P) {
        initComponents();
        this.setExtendedState(JFrame.MAXIMIZED_BOTH);

        this.pr = P;
        jLabel2.setText("level : " + pr.getRole());
        Laporan("");
    }
    ...
    if ("admin".equals(pr.getRole())) {
        this.setVisible(false);
        HalamanKasir ha;// Pastikan Anda menyimpan objek userprofile di tampilan user
        ha = new HalamanKasir(this.pr);
        ha.setVisible(true);
        ha.setExtendedState(JFrame.MAXIMIZED_BOTH);
    } else if ("kasir".equals(pr.getRole())) {
